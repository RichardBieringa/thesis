...
\usepackage{color}
\usepackage[svgnames]{xcolor} % Enables coloured text https://www.latextemplates.com/svgnames-colors
...
\usepackage{subcaption} % Have multi-chart figures with sub-captions
\usepackage{framed} % Emphasize text in shaded boxes
