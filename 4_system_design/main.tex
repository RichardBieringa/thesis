...
\chapter{Design and Implementation of a Mesh Bench, a Service Mesh Benchmark}
...
% - Results of 
The remainder of this chapter is structured as follows. First, in \cref{sec:system:objectives} we introduce the goals of the benchmarking instrument. Second, in \cref{sec:system:sut} we describe the components that are part of the \gls{sut}. Afterwards, in \cref{sec:system:requirements-analysis} we present a requirement analysis in which we formalize the stakeholders, use cases and system requirements of the instrument. Next, in \cref{sec:system:design} we present the design of the \textit{Mesh Bench}, a benchmarking instrument for \gls{sm} systems. Afterwards, in \cref{sec:system:implementation} we discuss the implementation details of a prototype that implements the benchmark design. Finally, in \cref{sec:system:summary} we summarize and conclude this chapter.
...
\input{4_system_design/sections/06_summary}
