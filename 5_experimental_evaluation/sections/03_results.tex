...
\input{5_experimental_evaluation/tables/main-findings}
...
% We first present the main findings in \cref{sec:experiments:main-findings}. After this, we present and explain how to interpret the results per experiment and discuss their findings in greater detail.
...
% We now present the main findings of the conducted experiments as seen in \cref{tab:experiment:main-fidings}.
